...
try:
	ser = serial.Serial(baudrate = 38400, port = '/dev/FuelCell', timeout = 0.6)
	print(ser.isOpen())
	print("port opened")
except:
	print("Does not open.")
...
def MFM(High_MFM, Low_MFM):
	return (High_MFM * 256 + Low_MFM)
...
#					incoming2.append(PowerBOP(voltage, CurrentBOP(current)))
					incoming2.append(MFM(incoming[18], incoming[19]))
